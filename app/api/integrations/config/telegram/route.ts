...
const AUDIENCE = "ficusin-store-telegram-config";
const REPOSITORY = "avpavlo8/ficusin-store";
const WORKFLOW_REF =
  "avpavlo8/ficusin-store/.github/workflows/telegram-config-sync.yml@refs/heads/main";
...
export async function POST(request: Request) {
  try {
    ...
    await storeEncryptedCredentials("telegram", envelope);
