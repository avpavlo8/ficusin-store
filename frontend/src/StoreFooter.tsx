...
export function StoreFooter() {
  ...
  return <footer className="store-footer">
    <div className="store-footer-grid">
      <section className="store-footer-connect"><a className="store-footer-chat" href="https://t.me/ficusin62" target="_blank" rel="noreferrer"><span>Написать в чат</span><i><SocialIcon path={socialIcons.chat}/></i></a><div className="store-footer-social-block"><p>Мы в соцсетях</p><div className="store-footer-socials"><a href="https://vk.ru/ficusin" target="_blank" rel="noreferrer" aria-label="Фикусин во ВКонтакте"><SocialIcon path={socialIcons.vk}/></a><a href="https://t.me/ficusin62" target="_blank" rel="noreferrer" aria-label="Фикусин в Telegram"><SocialIcon path={socialIcons.telegram}/></a><a href="https://www.instagram.com/ficusin_62/" target="_blank" rel="noreferrer" aria-label="Фикусин в Instagram"><SocialIcon path={socialIcons.instagram}/></a><a className="max-social" href="https://max.ru/channel_ficusin" target="_blank" rel="noreferrer" aria-label="Фикусин в MAX"><b>MAX</b></a></div></div></section>
    ...
    <div className="store-footer-bottom"><div className="store-footer-legal"><span>© Фикусин, {new Date().getFullYear()}</span><a href="/privacy">Политика конфиденциальности</a><a href="/offer">Публичная оферта</a></div><address className="store-footer-address"><a href="tel:+79156151100">+7 915 615-11-00</a><a href="mailto:info@ficusin.ru">info@ficusin.ru</a><a href="/contacts">Рязань, Новосёлов, 40А</a></address></div>
  </footer>;
}
