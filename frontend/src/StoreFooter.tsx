...
export function StoreFooter() {
  ...
  return <footer className="store-footer">
    ...
    <div className="store-footer-bottom"><span>© Фикусин, {new Date().getFullYear()}</span><a href="tel:+79156151100">+7 915 615-11-00</a><a href="mailto:info@ficusin.ru">info@ficusin.ru</a><a href="/contacts">Рязань, Новосёлов, 40А</a><a href="/privacy">Политика конфиденциальности</a><a href="/offer">Публичная оферта</a></div>
  </footer>;
}
