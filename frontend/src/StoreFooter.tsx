...
export function StoreFooter() {
  ...
  return <footer className="store-footer">
    <div className="store-footer-grid">
      <section className="store-footer-connect"><a className="store-footer-chat" href="https://t.me/ficusin62" target="_blank" rel="noreferrer"><span>Написать в чат</span><i><SocialIcon path={socialIcons.chat}/></i></a><p>Мы в соцсетях</p><div className="store-footer-socials"><a href="https://vk.ru/ficusin" target="_blank" rel="noreferrer" aria-label="Фикусин во ВКонтакте"><SocialIcon path={socialIcons.vk}/></a><a href="https://t.me/ficusin62" target="_blank" rel="noreferrer" aria-label="Фикусин в Telegram"><SocialIcon path={socialIcons.telegram}/></a><a href="https://www.instagram.com/ficusin_62/" target="_blank" rel="noreferrer" aria-label="Фикусин в Instagram"><SocialIcon path={socialIcons.instagram}/></a><a href="https://max.ru/channel_ficusin" target="_blank" rel="noreferrer" aria-label="Фикусин в MAX"><SocialIcon path={socialIcons.max}/></a></div></section>
