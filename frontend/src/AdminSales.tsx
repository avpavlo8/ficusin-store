...
const deliveryMethodLabels: Record<string, string> = { pickup: "Самовывоз", cdek: "СДЭК", courier: "Курьер", post: "Почта России" };
