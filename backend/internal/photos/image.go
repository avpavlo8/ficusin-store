...
// Двух размеров хватает на весь магазин: крупный открывается на карточке
// товара, мелкий стоит в плитке каталога. Третий, совсем маленький, пришлось
// бы тащить через весь фронтенд ради корзины — там и мелкий не тяжёл.
var (
	SizeLarge = Size{Name: "large", MaxSide: 1200}
	SizeCard  = Size{Name: "card", MaxSide: 600}
)

var Sizes = []Size{SizeLarge, SizeCard}
