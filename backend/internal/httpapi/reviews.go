...
type reviewStore interface { Create(context.Context,int64,string,reviews.Input)(int64,error); Photo(context.Context,int64)(string,[]byte,error); Pending(context.Context)([]reviews.ModerationItem,error); Moderate(context.Context,int64,int64,string)error }
