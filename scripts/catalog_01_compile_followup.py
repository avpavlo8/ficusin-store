...
replace_once("frontend/src/AdminPim.tsx", '  useEffect(() => setDraft(item), [item]);\n', '')
replace_once(
    "frontend/src/AdminPim.tsx",
...
replace_once("frontend/src/AdminPim.tsx", '  useEffect(() => { if (!categoryId && categories[0]) setCategoryId(categories[0].id); }, [categories, categoryId]);\n', '')
replace_once(
    "frontend/src/AdminPim.tsx",
...
replace_once("frontend/src/AdminPim.tsx", '<select value={categoryId || ""} onChange={(event) => setCategoryId(Number(event.target.value) || null)}>', '<select value={selectedCategoryId || ""} onChange={(event) => setCategoryId(Number(event.target.value) || null)}>')
replace_once(
    "frontend/src/AdminPim.tsx",
